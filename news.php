  ...
  new google.translate.TranslateElement({pageLanguage: 'tr', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
	  ...
	  <div id="contents">
	    <div id="adbox">
	      ...
	      <table width="944" height="2333" border="0">
		      <tr>
		        <th width="673" height="154" scope="row"><table width="694" height="286" border="0">
		          <tr>
		            <th scope="row"><embed src="script7/script1/script7.htm" width="660" height="518"></embed></th>
	              </tr>
	            </table></th>
		        <th width="261" rowspan="7" scope="row"><hr>
		      ...
		      <tr>
		        <th height="440" scope="row"><p>&nbsp;</p>
	              <table width="675" height="419" border="0">
	                <tr>
	                  <th height="23" bgcolor="#E75050" class="div5" scope="row"> Son Dakika Videoları</th>
                    </tr>
	                <tr>
	                  <th scope="row"><iframe width="640" height="360" src="https://www.youtube.com/embed/5oQRwbasseY" frameborder="0" allowfullscreen></iframe></th>
                    </tr>
                  </table>
                <p>&nbsp;</p></th>
	          </tr>
		      ...
		      <tr>
		        <th height="22" colspan="2" bgcolor="#E75050" class="div5" scope="row"> Son Dakika Fotoları</th>
	          </tr>
		      <tr>
