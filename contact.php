  ...
  new google.translate.TranslateElement({pageLanguage: 'tr', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
	  ...
	  <div id="contents">
	    <div id="adbox">
	      ...
	      <table width="944" height="3009" border="0">
		      <tr>
		      ...
		      <tr>
		        <th height="240" scope="row"><div class="yazı" id="featured">
		          <h3 class="font123"> Gezilecek Yerler</h3>
		          <ul>
		            <?php
				include("bag.php");
				$sorgu5=mysql_query("select * from gezi_hakkinda ");
				while($dizi5=mysql_fetch_array($sorgu5))
				{
					?>
		                ...
		                <p class="font123"><?php echo $dizi5[1] ?><br>
		                </p>
		      ...
		      <tr>
		        <th height="440" scope="row"><p>&nbsp;</p>
	              <table width="675" height="419" border="0">
	                ...
	                <tr>
	                  <th scope="row"><iframe width="640" height="360" src="https://www.youtube.com/embed/3wVHtfICMdk" frameborder="0" allowfullscreen></iframe></th>
                    </tr>
                  </table>
                <p>&nbsp;</p></th>
	          </tr>
		      ...
		      <tr>
		        <th height="22" colspan="2" bgcolor="#E75050" class="div5" scope="row">GEZİ YERLERİ</th>
	          </tr>
		      <tr>
		        <th height="458" colspan="2" align="left" valign="bottom" scope="row"><table width="938" height="456" border="0">
		          <tr>
		            <?php 
				  $sorgu8=mysql_query("select * from gezi_fotolari1");
				  while($dizi8=mysql_fetch_array($sorgu8))
				  { ?>
		            <th width="244" height="237" scope="row"><a href="fotogaleri.php?id14=<?php echo $dizi8[1]; ?>"/><img src="hababamadmin/images/foto galeri/<?php echo $dizi8[0]; ?>" alt="" width="214" height="206"></a></th>
                    <?php } ?>
	              </tr>
		          <tr>
		             <?php 
				  ...
				  { ?>
		            <th height="231" scope="row"><a href="fotogaleri.php?id15=<?php echo $dizi9[1]; ?>"/><img src="hababamadmin/images/foto galeri/<?php echo $dizi9[0]; ?>" alt="" width="214" height="206"></a></th>
                    <?php } ?>
	              </tr>
	            </table></th>
            </tr>
