  ...
  new google.translate.TranslateElement({pageLanguage: 'tr', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
	  ...
	  <div id="contents">
	    <div id="adbox">
	      ...
	      <table width="944" height="2446" border="0">
		      <tr>
		        <th width="673" height="311" scope="row"><table width="694" height="280" border="0">
		          <tr>
		      ...
		      <tr>
		        <th height="240" scope="row"><div id="featured">
		          <h3 class="font123"> Blog                  </h3>
		          <p><a href="" name="edittile" id="edittitle"></a>                  </p>
                  <div></div>
                 <?php include("bag.php");
				 $sorgu10=mysql_query("select * from blog");
		      ...
		      <tr>
		        <th height="440" scope="row"><p>&nbsp;</p>
	              <table width="675" height="419" border="0">
	                ...
	                <tr>
	                  <th scope="row"><iframe width="640" height="360" src="https://www.youtube.com/embed/5hnPGCjRaRM" frameborder="0" allowfullscreen></iframe></th>
                    </tr>
                  </table>
                <p>&nbsp;</p></th>
	          </tr>
		      ...
		      <tr>
		        <th height="454" colspan="2" align="left" valign="bottom" scope="row"><table width="938" height="452" border="0">
		          <tr>
		            <?php 
				  ...
				  {
				   ?> 
		            <th width="244" height="237" scope="row"><a href="fotogaleri.php?id5=<?php echo $dizi[1]; ?>"><img src="hababamadmin/images/foto galeri/<?php echo $dizi[0]; ?>" width="212" height="206"></a></th>
		            <?php
                    }
					?>
	              </tr>
				  ...
				  {
				   ?> 
		            <th width="244" height="208" scope="row"><a href="fotogaleri.php?id6=<?php echo $dizi1[1]; ?>"><img src="hababamadmin/images/foto galeri/<?php echo $dizi1[0]; ?>" width="212" height="206"></a></th>
		            <?php
                    }
					?>
	              </tr>
