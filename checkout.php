  ...
  new google.translate.TranslateElement({pageLanguage: 'tr', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
	  ...
	  <div id="contents">
	    <div id="adbox">
	      ...
	      <table width="944" height="2294" border="0">
		      <tr>
		        <th width="673" height="154" scope="row"><table width="662" height="499" border="0">
		          <tr>
		            <th width="656" height="495" scope="row"><embed src="script7/script1/script7.htm" width="660" height="518"></embed></th>
	              </tr>
	            </table></th>
		      ...
		      <tr>
		        <th height="440" scope="row"><p>&nbsp;</p>
	              <table width="675" height="419" border="0">
	                ...
	                <tr>
	                  <th scope="row"><iframe width="640" height="360" src="https://www.youtube.com/embed/pRH8akyb3Sc" frameborder="0" allowfullscreen></iframe></th>
                    </tr>
                  </table>
                <p>&nbsp;</p></th>
	          </tr>
