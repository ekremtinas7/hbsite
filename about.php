  ...
  new google.translate.TranslateElement({pageLanguage: 'tr', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
	  ...
	  <div id="contents">
	    <div id="adbox">
	      ...
	      <table width="944" height="2483" border="0">
		      <tr>
		        <th width="673" height="311" scope="row"><table width="694" height="356" border="0">
		          <tr>
		      ...
		      <tr>
		        <th height="570" scope="row"><div id="featured">
		          <h3 class="font123"> Hakkımızda</h3>
		          <ul>
		            <li><?php
				include("bag.php");
				$sorgu3=mysql_query("select * from hakkimizda ");
				while($dizi3=mysql_fetch_array($sorgu3))
				{
					?>
				
				
		              <h1 class="font123"><?php echo $dizi3[1] ?></h1>
		              <div>
		                
		                <p class="font123"><?php echo $dizi3[2] ?><br>
		                </p>
		      ...
		      <tr>
		        <th height="440" scope="row"><table width="675" height="419" border="0">
                  <tr>
	                ...
	                <tr>
	                  <th scope="row"><iframe width="640" height="360" src="https://www.youtube.com/embed/SbH6mXwseo8" frameborder="0" allowfullscreen></iframe></th>
                    </tr>
                  </table>
                <p>&nbsp;</p></th>
	          </tr>
		      ...
		      <tr>
		        <th colspan="2" align="left" valign="bottom" scope="row"><table width="938" height="485" border="0">
				  ...
				  {
				   ?> 
		            <th width="244" height="237" scope="row"><a href="fotogaleri.php?id6=<?php echo $dizi1[1]; ?>"><img src="hababamadmin/images/foto galeri/<?php echo $dizi1[0]; ?>" width="212" height="206"></a></th>
		            <?php
                    }
					?>
	              </tr>
